...
>(({ className, ...props }, ref) => {
  return (
    <Separator
      ...
      className={cn("mx-3 w-auto bg-border", className)}
      {...props}
    />
  )
})
